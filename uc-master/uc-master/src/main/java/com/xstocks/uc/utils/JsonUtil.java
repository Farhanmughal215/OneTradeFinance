...
public class JsonUtil {
    ...
    public static String toJSONString(Object object) {
        ...
        try {
            ...
            LOGGER.error("toJSONString object：{}", toJSONString(object), e);
        }
        return null;
    }
    ...
    public static ObjectNode toObjectNode(Object object) {
        try {
            ...
            LOGGER.error("toObjectNode error", e);
        }
        return null;
    }
    ...
    public static <T> T parseObject(String jsonString, Class<T> clazz) {
        try {
            ...
            LOGGER.error("parseObject exception jsonString is {}", jsonString, e);
        }
        return null;
    }
    ...
    public static <T> T jsonNode2Object(JsonNode jsonNode, Class<T> clazz) {
        try {
            ...
            LOGGER.error("jsonNode2Object exception", e);
        }
        return null;
    }
    ...
    public static Map<Object, Object> convertPojo2Map(Object pojo) {
        try {
            ...
            LOGGER.error("convertPojo2Map exception ", e);
        }
        return null;
    }
    ...
    public static Map parseObject(String jsonString) {
        try {
            ...
            LOGGER.error("parseObject jsonString ：{}", jsonString, e);
        }
        return null;
    }
