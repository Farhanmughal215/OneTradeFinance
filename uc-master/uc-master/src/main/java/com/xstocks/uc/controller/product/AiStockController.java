...
@Slf4j
@RestController
public class AiStockController extends BaseController {

    private final static String PRODUCT_TAG = "aistock";

    @RateLimit
    @PostMapping("/a/aistock/**")
